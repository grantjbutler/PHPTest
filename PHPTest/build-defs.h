...
#define CONFIGURE_COMMAND " './configure'  '--host=arm-apple-darwin10' '--enable-embed=static' '--without-pear' '--disable-opcache' '--without-iconv' '--disable-cgi' '--disable-shared' '--disable-cli' '--enable-mysqlnd' '--with-pdo-mysql' '--with-mysqli' '--with-tsrm-pthreads'"
...
#define PHP_EXTENSION_DIR       "/usr/local/lib/php/extensions/no-debug-non-zts-20121212"
